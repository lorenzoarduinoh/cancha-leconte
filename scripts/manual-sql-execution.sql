-- Manual Team Names Migration
-- Execute this SQL in the Supabase SQL Editor

-- Step 1: Add team name columns to games table
ALTER TABLE games 
...
-- Step 2: Add constraints for team names
ALTER TABLE games 
...
-- Step 3: Update existing games to have default team names
UPDATE games 
SET 
...
-- Step 7: Create audit logging function for team name changes
...
BEGIN
    ...
    IF OLD.team_a_name != NEW.team_a_name OR OLD.team_b_name != NEW.team_b_name THEN
        INSERT INTO admin_audit_log (
            ...
            -- We'll need to get this from the application context
            COALESCE(
...
-- Step 8: Create trigger for team name changes audit logging
